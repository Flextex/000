...
if(trim($name_register) == '') {
	...
	exit();
} else if(trim($profession ) == '') {
	echo '<div class="error_message">Please enter your profession.</div>';
	exit();
...
$usermessage = "Thank you for submit your restaraunt to PROZIM. We will reply shortly with more details!";
